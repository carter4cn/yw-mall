...
type ListUserRefundRequestsLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewListUserRefundRequestsLogic(ctx context.Context, svcCtx *svc.ServiceContext) *ListUserRefundRequestsLogic {
	return &ListUserRefundRequestsLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *ListUserRefundRequestsLogic) ListUserRefundRequests(in *order.ListUserRefundRequestsReq) (*order.ListRefundRequestsResp, error) {
	page := in.Page
	if page <= 0 {
		page = 1
	}
