...
type ListShopOrdersLogic struct {
	ctx    context.Context
	svcCtx *svc.ServiceContext
	logx.Logger
}

func NewListShopOrdersLogic(ctx context.Context, svcCtx *svc.ServiceContext) *ListShopOrdersLogic {
	return &ListShopOrdersLogic{
		ctx:    ctx,
		svcCtx: svcCtx,
...
func (l *ListShopOrdersLogic) ListShopOrders(in *order.ListShopOrdersReq) (*order.ListOrdersResp, error) {
	...
	return &order.ListOrdersResp{Orders: pbOrders, Total: total}, nil
}
